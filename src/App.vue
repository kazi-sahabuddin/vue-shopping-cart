...
let shoppingEstimate = computed(() => (subTotal.value > 10000 ? 100 : 50));

let taxEstimate = computed(() => subTotal.value * 0.08)

let total = computed(() => subTotal.value + shoppingEstimate.value + taxEstimate.value)
